...
$(document).ready(function(){
    // 토글
    // const $toggleDesc = $('div.eToggle .contents');
    // const $toggleTitle = $('div.eToggle .title');
    // const $toggleIcon = $('div.eToggle .title i')

    // $toggleDesc.hide();
    // $toggleTitle.click(function(){

    //     if($toggleIcon.hasClass('active') !== true || $(this).children('div.eToggle i').hasClass('active') === true) {
    //         $(this).children('div.eToggle i').toggleClass('active');
    //     } else {
    //         $toggleIcon.removeClass('active');
    //         $(this).children('div.eToggle i').toggleClass('active');
    //     }

    //     $toggleDesc.not($(this).next($toggleDesc).slideToggle()).slideUp();
    // });


    // $('dl.eToggle dt').click(function(){

    //     if($('dl.eToggle dt').hasClass('selected') !== true || $(this).hasClass('selected') === true) {
    //         $(this).toggleClass('selected');
    //     } else {
    //         $('dl.eToggle dt').removeClass('selected');
    //         $(this).toggleClass('selected');
    //     };
        
    //     $('dl.eToggle dd').not($(this).next($('dl.eToggle dd')).slideToggle()).slideUp();
...
// 게시물 띄워쓰기 제거
$('.xans-board-list .subject img:first-child').each(function(){
    $($(this)[0].previousSibling).remove();
});

$('.xans-myshop-boardpackage .list .subject img:first-child').each(function(){
    $($(this)[0].previousSibling).remove();
});